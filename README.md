...
Automated tests for https://www.saucedemo.com using Selenium + TestNG + Java.
...
&nbsp;    (or \*\*Debug 'testng.xml'\*\* if you want breakpoints)



&nbsp;  IntelliJ will execute all 3 tests automatically.
